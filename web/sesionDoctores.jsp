<%-- 
    Document   : sesionDoctores
    Created on : Aug 25, 2020, 5:24:34 PM
    Author     : Sofia
--%>
...
<html>
    ...
    <body>
       <div>Bienvenido/a a su sesion Doctor/a</div>
        <br>
        <a href="PacienteServlet?formid=3">Go to paciente</a>
        <br>
        <a href="MedicoServlet?formid=3">Go to medico</a>
        <br>
    ...
    <br>
    <a href="doctores.jsp">Regresar</a>
</html>
